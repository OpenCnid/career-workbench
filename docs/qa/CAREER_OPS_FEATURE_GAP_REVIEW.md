...
| -------------------------- | ---------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| First-run profile          | CV paste, LinkedIn-style input, conversational experience intake, target role and search constraints       | Guided identity and résumé/manual history; editable canonical search direction                   | Partial. Saved résumé text has no in-product organizer action; target/search criteria now have a dedicated later editor.                                                      |
...
4. Add a résumé-to-proposed-claims organizer and browser evidence-admission
   workflow; saved résumé text is currently archival.

P1 parity opportunities:

1. Organize a saved résumé into proposed, reviewable claims through DSH.
2. Expand the editable target/preferences rubric beyond the current skills and
   preferences dimensions, and make comparison roles/scenarios user-selectable.
3. Add selective, editable, diffable document drafting plus ATS/PDF output.
4. Add interview, offer/negotiation, and funnel-analysis workflows.
5. Add decision-oriented pipeline/funnel analytics and stale-result recovery.
