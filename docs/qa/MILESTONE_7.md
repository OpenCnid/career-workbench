...
Milestone 7 completes the day-to-day human-controlled product loop. Users can
...
- Search is a bounded backend query over canonical records. JSON export contains
  ...
  source text/locator or selected sealed source bytes by default.
...
pnpm test:e2e
chromium: 2 passed (21.5s)
axe: no serious or critical violations on ten primary routes
```
...
cancellation intent, restart recovery, responsive navigation, and keyboard
operation.
